...
import './DepthText.theme.css';

/**
 * Vendored from React Bits (reactbits.dev) — DepthText, JS variant. Kept
 * verbatim (only the "use client" directive added, since this project is
 * Next.js App Router); site-specific colour/scale adaptation for the header
 * usage lives in DepthText.theme.css and in the props passed at the call
 * site, not in here.
 */
